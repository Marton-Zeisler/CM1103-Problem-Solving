...
def sortStudents(a):
	return sorted(a, key=lambda x: (-x[1] if isinstance(x[1], int) else x[1], x[0].split()[1], x[0].split()[0]))
	

#print(sortStudents([("Alfa Balamar", "B"), ("Alapa Alamdar", "B"), ("Zeos;er Zeoz;e", "A")]))
